...
# Imposta notifiche{#set-up-notifications}
...
<table frame="all" colsep="1" rowsep="1" id="table_ios_notifications"> 
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> È stato impostato un <span class="codeph"> PTMediaPlayerItem </span> diverso di <span class="codeph"> PTMediaPlayer </span>. </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> È stata aggiunta una nuova <span class="codeph"> notifica PTN </span> al <span class="codeph"> PTNotificationHistoryItem </span> dell'elemento <span class="codeph"> PTMediaPlayerItem </span> corrente, ovvero quando viene aggiunto un evento di notifica alla cronologia delle notifiche. </td> 
  </tr> 
  <tr rowsep="1"> 
