...
1. Caricate la risorsa multimediale utilizzando una delle seguenti opzioni:
   ...
   * L’istanza di MediaPlayer.
      ...
      Per ulteriori informazioni, vedere [Caricare una risorsa multimediale in Mediaplayer](../../../tvsdk-1.4-for-desktop-hls/t-psdk-dhls-1.4-configure/c-psdk-dhls-1.4-mediaplayer-initialize-for-video/t-psdk-dhls-1.4-media-resource-load.md).
