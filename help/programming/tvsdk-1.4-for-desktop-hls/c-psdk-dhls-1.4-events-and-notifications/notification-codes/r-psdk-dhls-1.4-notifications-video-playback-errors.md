---
description: L'interfaccia Video Encoder dell'AVE restituisce queste notifiche di riproduzione video nell'oggetto metadati NATIVE_ERROR.
...
<table> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Valore della chiave di metadati RUNTIME_CODE </th> 
   <th colname="col2" class="entry"> Valore della chiave di metadati RUNTIME_CODE_MESSAGE </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> Il lettore multimediale non è in grado di caricare segmenti perché ha raggiunto la fine della finestra live. Il caricamento del segmento riprenderà quando il server aggiungerà nuovi file multimediali alla finestra live. Questo stato viene generalmente raggiunto se: 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">Il periodo successivo è un periodo live con una sostituzione di file multimediali in sospeso (a causa di <span class="codeph"> InsertBy</span> chiamata API) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> Riproduzione HLS non abilitata nel Flash Player. Vedere <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>. </td> 
  </tr> 
  <tr> 
