---
description: L'interfaccia Video Encoder di AVE restituisce queste notifiche di riproduzione video nell'oggetto metadati NATIVE_ERROR.
...
<table> 
 <thead> 
  <tr> 
   <th colname="col1" class="entry"> Valore per la chiave dei metadati RUNTIME_CODE </th> 
   <th colname="col2" class="entry"> Valore per la chiave dei metadati RUNTIME_CODE_MESSAGE </th> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> Il lettore multimediale non è in grado di leggere ulteriormente perché ha raggiunto l'ora impostata da <span class="codeph"> setHoldAt</span> API. </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> Il lettore multimediale non è in grado di caricare i segmenti perché ha raggiunto la fine della finestra live. Il caricamento del segmento riprenderà quando il server aggiunge nuovi file multimediali alla finestra live. Questo stato viene generalmente raggiunto se: 
    <ul id="ul_FCFF658EDA4144E59970B317D6DEB624"> 
     ...
     <li id="li_1B14716B2157492AB1859306D1250523">Il periodo successivo è un periodo live con una sostituzione dei contenuti multimediali in sospeso (a causa di <span class="codeph"> InserisciPer</span> chiamata API) </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> La riproduzione HLS non è stata abilitata nel Flash Player. Consulta <span class="codeph"> AuthorizedFeatures.enableHLSPlayback</span>. </td> 
  </tr> 
  <tr> 
