...
<table frame="all" colsep="1" rowsep="1" id="table_BC74F0C72F7C443B92C9B28750D812A6"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe che estende Track per definire l'astrazione dei sottotitoli. Un brano con sottotitoli codificati viene definito in modo univoco in base al nome E al tipo di servizio. Diversi tipi di servizio possono condividere lo stesso nome.</td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Classe che contiene i tipi di traccia dei sottotitoli predefiniti. </td> 
  </tr> 
  <tr rowsep="1"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/info/DefaultPlaybackRates.html" format="html" scope="external"> Percentuali di riproduzione predefinite</a></span> </td> 
