...
| [AdPolicyInfo](https://help.adobe.com/en_US/primetime/api/psdk/asdoc-dhls_1.4/com/adobe/mediacore/timeline/advertising/policy/AdPolicySelector.html) | Interfaccia che definisce le proprietà per le chiamate `AdPolicySelector` API. Queste proprietà forniscono il contesto per l&#39;imposizione di ogni comportamento annuncio. |
