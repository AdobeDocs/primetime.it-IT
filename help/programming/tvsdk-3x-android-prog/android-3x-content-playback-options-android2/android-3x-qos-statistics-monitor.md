...
1. Chiamate `event.getLoadInformation()` per leggere i dati pertinenti dal parametro `event` passato al callback.
   ...
   >[!NOTE]
   >
   >Per ulteriori informazioni su `LoadInformation`, vedere [3.0 per i documenti API Android (Java)](https://help.adobe.com/en_US/primetime/api/psdk/javadoc3.0/index.html).
