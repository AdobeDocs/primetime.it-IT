---
description: Alcune API possono essere utili per usare il Flash Player di Adobe.
title: API utili per il Flash Player Adobe
...
# API utili per il Flash Player Adobe{#helpful-apis-for-the-adobe-flash-player}
