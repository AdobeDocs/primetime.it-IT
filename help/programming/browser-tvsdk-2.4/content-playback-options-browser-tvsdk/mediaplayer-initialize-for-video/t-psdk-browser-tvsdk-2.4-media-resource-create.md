...
1. Creare un `MediaResource` trasmettendo informazioni sul supporto al costruttore `MediaResource`.
   ...
   >[!TIP]
   >
   >In qualsiasi momento successivo, puoi utilizzare gli accessori `MediaResource` per esaminare il tipo, l&#39;URL e i metadati della risorsa.

1. Caricate l’istanza di MediaPlayer. Per ulteriori informazioni, vedere [Caricare una risorsa multimediale in MediaPlayer](../../content-playback-options-browser-tvsdk/mediaplayer-initialize-for-video/t-psdk-browser-tvsdk-2.4-media-resource-load.md).
