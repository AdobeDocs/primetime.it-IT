...
Per ricevere notifiche su tutti gli eventi relativi a QoS, registrare un&#39;implementazione `MediaPlayer.QOSEventListener` che include le seguenti callback:
...
| [onOperationFailed](https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/MediaPlayer.QOSEventListener.html)(MediaPlayerNotification). [Avviso](https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/MediaPlayerNotification.Warning.html) ) | Si è verificato un errore reversibile. |
