---
description: TVSDK include metodi, proprietà ed eventi per determinare le percentuali valide, le percentuali correnti, se è supportata la riproduzione per trucco e altre funzionalità relative alla riavvolgimento e avanzamento rapido.
...
* `MediaPlayerItem.getAvailablePlaybackRates` - specifica le percentuali valide.
