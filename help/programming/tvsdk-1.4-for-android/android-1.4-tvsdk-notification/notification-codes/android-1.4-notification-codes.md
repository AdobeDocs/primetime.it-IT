...
<table frame="all" colsep="1" rowsep="1" id="table_DBA8CACF02DB4AF2B053E560850B49CE"> 
 ...
 <tbody> 
  <tr rowsep="1"> 
   ...
   <td colname="2">Tipo di notifica. A seconda della piattaforma, questa proprietà fa riferimento a un tipo enumerato con possibili valori di <span class="codeph"> INFO</span>, <span class="codeph"> WARN</span> o <span class="codeph"> ERROR</span>. Questo è il raggruppamento di livello principale per le notifiche. </td> 
  </tr> 
  <tr rowsep="1"> 
