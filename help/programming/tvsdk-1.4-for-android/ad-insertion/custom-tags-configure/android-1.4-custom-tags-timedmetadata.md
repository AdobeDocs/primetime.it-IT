...
<table id="table_FFC56AC5B1E04DA99C9309C0223ABA90"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Identificatore univoco dei metadati temporizzati. Questo valore viene solitamente estratto dall’attributo cue/tag ID . In caso contrario, viene fornito un valore casuale univoco. Utilizza <span class="codeph"> getId </span>. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <span class="codeph"> metadati  </span> </td> 
   <td colname="col02"> Metadati </td> 
   <td colname="col2"> Le informazioni elaborate/estratte dal tag personalizzato playlist/manifest. Utilizza <span class="codeph"> getMetadata </span>. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> Il tipo di metadati temporizzati. Utilizza <span class="codeph"> getType </span>. 
...
| `public TimedMetadata(Type type, long time, long id, String name, Metadata metadata);` | costruttore predefinito (l&#39;ora è l&#39;ora del flusso locale). |
...
| `public Type getType();` | Restituisce il tipo di metadati temporizzati. |
