...
L&#39;API del server manifesto presuppone che qualsiasi lettore video che lo utilizza soddisfi i requisiti minimi. Per ulteriori informazioni, vedere [Requisiti del lettore video](/help/primetime-ad-insertion/~old-msapi-topics/ms-player-req.md).
