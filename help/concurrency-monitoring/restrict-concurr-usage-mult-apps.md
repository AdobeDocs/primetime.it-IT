...
Per l’integrazione con CM, è necessario creare un ticket Zendesk (https://adobeprimetime.zendesk.com) e specificare le seguenti informazioni:

1. il nome della società
1. le applicazioni che si desidera integrare con CM. Per ogni applicazione, devi fornire:
   - nome applicazione
   - piattaforma applicativa
1. la terza parte che ha richiesto l’integrazione (se applicabile)


Dopo aver creato il ticket, verranno rilasciate le seguenti informazioni:
...
Le seguenti voci DEVONO essere inserite nella(e) applicazione(i):
