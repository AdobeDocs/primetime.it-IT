...
+ Ad Insertion Primetime {#ptai}
   + [Note sulla versione di PTAI 22.9.2](ptai-22x-release-notes.md)
...
+ TVSDK del browser {#browser-tvsdk}
   + [Note sulla versione di TVSDK 2.4 per il browser](tvsdk-24-browser.md)
+ TVSDK per HLS desktop {#tvsdk-desktop-hls}
   + [Note sulla versione di TVSDK 1.4 per HLS desktop](tvsdk-1-4-desktop-hls.md)
+ Packager offline Primetime {#offline-packager}
...
+ Server di streaming Primetime {#streaming-server}
   + [Versioni di Primetime Streaming Server versione 1](primetime-streaming-server-1x.md)
