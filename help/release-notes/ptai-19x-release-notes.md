...
**Quando:** martedì 10 settembre 2019 alle 12:30 alle 2:00 ora orientale
...
* SSAI: È stato aggiunto il supporto per i token di autenticazione CDN Limelight (LLNW) per i segmenti di contenuto
   * Quando `pttoken=limelight` o `pttoken=llnw` viene aggiunto all&#39;URL del programma di avvio, quando si recupera la playlist principale di origine verrà aggiunta un&#39;intestazione segreta, i parametri di query verranno aggiunti dall&#39;intestazione X--Sig di LLNW ai segmenti di contenuto
* SSAI: È stato aggiunto un altro valore token (`pttoken=centurylink`) per il supporto del token di autenticazione CDN CenturyLink, rilasciato il 30 luglio 2018
   * `pttoken=centurylink` ha lo stesso comportamento  `pttoken=level3`e entrambi i valori sono validi

### Versione 19.5.1

**Quando:** Giovedi, 9 Maggio 2:30 Ora orientale a Giovedi, 9 Maggio 4:30 Ora orientale
...
**Quando:** Mercoledì, Aprile 10 2:30 Ora orientale a Mercoledì, Aprile 10:30 Ora orientale
...
**Che cosa:componente** Primetime e Disegno dell’interfaccia utente Web
