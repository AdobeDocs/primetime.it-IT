...
1. Convalida autenticazione e autorizzazione.
   ...
   - Se `getAuthorization()` failed: esamina l’eccezione generata per determinarne il tipo (AuthN, AuthZ o altro):
      ...
      - Se si è verificato un errore di autorizzazione (AuthZ), l’utente non è autorizzato a guardare il contenuto multimediale richiesto e deve visualizzare all’utente un qualche tipo di messaggio di errore.
